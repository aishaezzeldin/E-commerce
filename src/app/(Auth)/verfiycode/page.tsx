...
export default function virfypass() {
  ...
  <>
   ...
   <h4 className='my-6 w-full sm:w-3/4 font-bold sm:text-base text-4xl'>Security code to verfiy password</h4>
